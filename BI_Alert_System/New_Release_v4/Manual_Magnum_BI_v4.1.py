...
#############################################
# 2020-02-07 17:00:00
days = pd.date_range('2020-02-13 23:50:00', periods=round((datetime.now()-datetime(2020,2,13,23,50,0)).total_seconds()/3600)+1, freq='H').tolist()
days = days[:-1]
